#!/usr/bin/env python3
"""Recipe for training social ambiance (concurrent speaker count) from speech data.
The system classifies 6 classes (no speech, 1 spk, 2spk, 3spk, 4spk, >=5spk) with finetuned wav2vec.

To run this recipe, do the following:
> 1. python wav_to_json.py
> 3. for single gpu: python finetune_wav2vec2.py hparams/finetune_wav2vec2.yaml 
     for multi-gpu: CUDA_VISIBLE_DEVICES=3,4 python finetune_wav2vec2.py hparams/finetune_wav2vec2.yaml --data_parallel_backend
